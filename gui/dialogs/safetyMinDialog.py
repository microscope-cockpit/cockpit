...
class SafetyMinDialog(wx.Dialog):
    def __init__(
        ...
        slideSafetyButton.SetToolTip("Set the safety to a good value for slide experiments")
        ...
        dishSafetyButton.SetToolTip("Set the safety to a good value for dish experiments")
        ...
        startButton.SetToolTip("Apply the chosen safety min")
