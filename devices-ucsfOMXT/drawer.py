...
## This is largely copied from the OMX drawer code. OMXT doesn't have 
# drawers in the standard sense though, so this is mostly just fake.
class DrawerDevice(device.Device):
    def getHandlers(self):
        ...
        cameraNames = ('iXon1', 'Neo', 'Zyla', 'East')
