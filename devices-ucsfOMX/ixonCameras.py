...
class CameraDevice(device.Device):
    ...
    def getHandlers(self):
        result = []
        # Note that the 192.168.12.42 computer was deprecated when we
        # got an iXon Ultra. That computer is still around, just in case
        # one of the others bites the bucket...
